                            ...
                            <TooltipTrigger asChild>
                              <button
                                ...
                                className={cn(
                                  ...
                                  isCluster && "h-8 w-8 bg-[rgb(174, 55, 166)] ring-4 ring-card before:absolute before:inset-[-5px] before:-z-10 before:rounded-full before:border-2 before:border-current before:bg-transparent before:opacity-100 after:absolute after:inset-[-9px] after:-z-20 after:rounded-full after:border after:border-current after:opacity-35"
                                )}
                                style={style}
